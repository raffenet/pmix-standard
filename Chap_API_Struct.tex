...
\adviceuserstart
# SOLT: TODO: Isn't this wrong now?  I think this is referring to implementation specific error codes (because it says greater than PMIX_EXTERNAL_ERR_BASE), but 
it doesn't say that.
