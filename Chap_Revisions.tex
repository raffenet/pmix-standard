...
\begin{compactitemize}
  ...
  \item Add example C and Python PMIx client codes in sources/ directory
  ...
  \item Re-organize the presentation of data access, syncronization, reserved keys and non-reserved keys. % \#405 \#175 - dsolt
  \item Make presentation of return values consistent across APIs % \#350 - dsolt
  \item Attributes supported by PRRTE are no longer color coded.  Refer to PRRTE documentation to see what is supported for a particular PRRTE version. % - dsolt
\end{compactitemize}
